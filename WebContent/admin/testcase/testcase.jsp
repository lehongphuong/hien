...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style="background-color:rgb(26, 170, 154);">
		<ul class="nav menu" style="padding-top:30px;font-size:20px;font-family:myFirstFont;">
			...
			<li class="active"><a href="/FPT/list-testcase.do" style="color:#fff;"><svg class="glyph stroked key"><use xlink:href="#stroked-key"></use></svg>Testcase</a></li>
					...
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="subId" data-sortable="true">Subject Id</th>
							...
							<tr>
								...
								<td><jsp:getProperty name="testcase1" property="testId"/> </td>
