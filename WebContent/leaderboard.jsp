...
<!-- /.Customizer -->
 ...
 <table class="table table-hover">
    <thead>
      <tr>
      	<th><h5><span class="badge black">Rank</span></h5></th>
       	<th><h5><span class="badge black">Hacker</span></h5></th>
       	<th><h5><span class="badge black">Points</span></h5></th>
       	<th><h5><span class="badge black">University</span></h5></th>
      </tr>
    </thead>
    <tbody>
    
     <logic:iterate id="user" name="homeForm" property="userList">
     ...
     <tr>
		...
		<td><jsp:getProperty name="user" property="point"/></td>
       <td><bean:write name="user" property="university"/></td>
